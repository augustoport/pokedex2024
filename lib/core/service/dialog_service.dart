...
class DialogService {
  late Function(String title, String? message, String confirmText, bool fixed)
      _showDialogListener;
  ...
  void registerDialogListener(Function showDialogListener) {
    _showDialogListener =
        showDialogListener as dynamic Function(String, String?, String, bool);
  }

  /// Calls the dialog listener and returns a Future that will wait for dialogComplete.
  Future showDialog(String title, String message,
      {String confirmText = 'OK', bool fixed = false}) {
